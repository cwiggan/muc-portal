    ...
    'collections' => array(
        ...
        'public' => function($collection)
        {
            $collection->directory('assets/css', function($collection)
            {
                ...
                $collection->add('ionicons.min.css');
                $collection->add('morris/morris.css');
                $collection->add('bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css');
                $collection->add('AdminLTE.css');                
